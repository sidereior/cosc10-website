    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Over the summer between my sophomore and junior year, I worked full-time within the Ohio State University's Department of Aerospace and Mechanical Engineering as a computer science researcher. Over this summer I worked on the M-Themes project which is a Mesoscale Thermomechanical Materials Simulator written in C. I worked entirely in C and Iimplemented a variety of fast-fourier smoothing algorithms using the FFTW library, updating outdated libraries throughout the codebase, preformed continual data-analysis on runtime and space complexity, and presented at both OSU and to my school faculty. Looking back, doing low-level programming in C relatively early on was invaluable for my growth as a programmer and built a foundation to truly understand how a computer functions that I would build upon later. This was my first experience in the \"real-world\" and exposed me to what software and research truly look like.",
          imageSrc: require('@/assets/osu.png'), 
          parallaxBackground: require('@/assets/data.png'), 
        },
        {
          title: "Courses",
            description: "Over the course of my time at Columbus Academy High School I took three computer science courses. I unfortunately don't have any of the syllabi, so I'll describe the content and a few highlights. The first, Honors CS 1 (HCS1), was a pretty standard AP Computer Science A course taught in Java. I ended with an A+ and a 5 on the AP. My sophomore year I took HCS2, which is the equivalent of a college level data-structures and algorithm course or AP Computer Science AB (that has been discontinued). This course taught data-structures, algorithms, and time complexity, and one of the favorite projects I built for this class was a predictive-text language-generator where you could give the program a handful of texts and then have a conversation with it based upon what it 'knows'. I scored a A+ in this class and it was a highlight of high school. In my junior year I took HCS3. I have never found a great college-equivalent of this course, but it was a college-level course, but topics included the history of CS, state machines & circuits, one instruction set computers, and networking. The highlights of this course for me was building a LAN network zombie-survival game (and entirely re-building it the night before it was due) along with making a handful of intersting mathematical functions in a subleq-like language. I ended the year with an A+ in this course also.",
          imageSrc: require('@/assets/ca.png'), 
          parallaxBackground: require('@/assets/robotics.png'), 
        }, 
        {
          title: "Clubs & Other Experiences",
            description: "Over the course of my time at Columbus Academy High School I also was a part of a handful of clubs related to CS. Most notably I was the president of our Code Club for my Junior and Senior year, where I made and graded monthly problem sets, hosted a handful of code-your-own-bot competitions for games we coded from scratch, taught content, and prepared labs for students to learn from. Also, during my junior to senior year summer I attended the Management and Technology Summer Institute at the Univeristy of Pennsylvania. Here I took EAS 0028 (see Dept. of Engineering and Applied Sciences at UPenn) which involved us building a hardware product startup from start to end in three weeks and invovled circuits and some basic C++.",
          imageSrc: require('@/assets/ca.png'), 
          parallaxBackground: require('@/assets/robotics.png'), 
        },
        {
          title: "Startups",
            description: "Making startups has been by far the most enjoyment I have had in programming. Most recently I have Co-Founded PaidPlanet with a Graduate Student from UPenn. PaidPlanet is releasing later this month and is the first app that pays for everyday sustainable action. I wrote the IOS app using Swift, our backend is in Firebase, and we have a new website coming soon in Vue.js. Check out more at paidplanet.com. During my sophomore year I founded KnowBeforeYouGo along with two friends and am the Chief Architect. KnowBeforeYouGo provides both hardware and software to analyze the number of people within a location at a given time and provides software to consumers to see how busy locations are such as resturants, malls, or even parks. We also provide software to businesses that uses AI to predict the business of locations and can help optimize employment schedules. Over the two years which we worked on KnowBeforeYouGo we wrote code in Flutter, Microjava, Java, and SQL as well as designed and produced hardware & firmware for our physical devices that would collect data at a specific location. Check out more at bdoyan.com",
          imageSrc: require('@/assets/avatar.png'), 
          parallaxBackground: require('@/assets/paid.png'), 
        },
        {
            title: "Projects",
            description: "Over the years programming, I have almost always been working on personal projects. Recently I made an physically-based rendering engine in Rust in two weeks from scratch (see a youtube video I made: youtube.com/watch?v=MnoGSOUFFjA). Some of my favorite projects have been MERCOR, which is a language I wrote in Java that is designed for applications in economics involving anything from stock lookups to easily performing complex calculations based upon real-time data. Another of my favorites is the smart-contracts I wrote for both the PennApps XXIII hackathon and BitApps hackathon and experimenting with zero-knowledge proofs. After the release of PaidPlanet I am planning on working on WebQL, a new query language and database type that I have been thinking about for a while which incorporates fundamental HTTPS-based programming paradigms from MERCOR to databases written in Rust. I'd encourage you to check out my GitHub if you want to see more of my projects and code. If you've made it this far, I really want to thank you for taking the time to evaluate my CS placement at Dartmouth. Looking forward to meeting everyone soon! - Alex",
          imageSrc: require('@/assets/avatar.png'), 
